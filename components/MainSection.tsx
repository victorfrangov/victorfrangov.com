    ...
    <>
      ...
      >
        ...
        <div className="space-y-2 sm:space-y-4">
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[7.2vw] 2xl:text-[7.4rem] font-extrabold tracking-[-0.045em] leading-[0.95] uppercase">
            <div>{t("main.hero.title.line1")}</div>
            <div className="flex flex-wrap items-baseline gap-x-3 sm:gap-x-4 mt-1 sm:mt-2">
