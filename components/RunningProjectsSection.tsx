...
async function getGitHubRepos(): Promise<GitHubRepo[]> {
  try {
    const response = await fetch("https://api.github.com/users/victorfrangov/repos?sort=updated&per_page=6", {
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-16 gap-8 lg:gap-16">
          ...
          <div className="max-w-md lg:text-right">
            <p className="text-muted-foreground mb-8 text-lg">
              As a full-stack developer, I focus on creating efficient solutions using modern technologies. From idea to
              prototype to deployment, I bring projects to life with clean code and best practices.
            </p>
            <Link
              href="#contact"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {repos.length > 0 ? (
            ...
            <div className="col-span-full text-center py-12">
              ...
              <p className="text-muted-foreground">Check out my projects on GitHub</p>
              <Link
